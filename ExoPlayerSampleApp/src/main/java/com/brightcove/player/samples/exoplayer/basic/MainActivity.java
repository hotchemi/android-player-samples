...
public class MainActivity extends BrightcovePlayer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // HLS Live DVR
        String bcovLiveDVRHLSURL = "http://bcoveliveios-i.akamaihd.net/hls/live/215102/master_english/398/master.m3u8?playerId=255166148200&lineupId=&affiliateId=&pubId=2402232199001&videoId=2552000984001";
        ...
        // Brightcove HLS served over http
        String bcovHttpHLSURL = "http://c.brightcove.com/services/mobile/streaming/index/master.m3u8?videoId=3637780364001";

        // Brightcove HLS served over https
        String bcovHttpsHLSURL = "https://secure.brightcove.com/services/mobile/streaming/index/master.m3u8?videoId=4073047675001&secure=true";

        // Once and OnceUX, Not currently supported
        ...
        Video video = Video.createVideo(bcovHttpHLSURL);
        ...
        String appsciDefaultApiToken = "ZUPNyrUqRdcAtjytsjcJplyUc9ed8b0cD_eWIe36jXqNWKzIcE6i8A..";
        ...
        String hlsOnlyMultiRenditionReferenceId = "74sec-multi-rendition";
...
//        Catalog catalog = new Catalog(appsciDefaultApiToken);
